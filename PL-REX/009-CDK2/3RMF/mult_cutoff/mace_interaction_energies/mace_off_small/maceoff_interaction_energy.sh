...
#   sbatch mace_interactions_cpu.sh 3RMF/results
#   sbatch mace_interactions_cpu.sh \
#       3RMF/results \
#       3RMF/results/mace_off_interaction_energies
#
# Calculations:
#
...
PYTHON_SCRIPT="${PYTHON_SCRIPT:-${SCRIPT_DIR}/maceoff_interaction_energy.py}"

RESULTS_ROOT="${1:-3RMF/results}"

# For RESULTS_ROOT=3RMF/results:
# SYSTEM_DIR becomes 3RMF
