...
INPUT_CSV="${SLURM_SUBMIT_DIR}/3SQQ/results/mace_off_interaction_energies/mace_off_interaction_all_cutoffs.csv"
OUTPUT_PNG="${SLURM_SUBMIT_DIR}/3SQQ/results/mace_off_interaction_energies/interaction_energy_vs_cutoff.png"
