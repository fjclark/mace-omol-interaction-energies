...
def run_pocket_mlp_optimisation(
    ...
    try:
        ...
        # Pocket RMS displacement
        # This calculates the direct RMS coordinate movement of pocket atoms.
        print(
        ...
        # Pocket maximum displacement
        # This reports the largest movement among all selected pocket atoms.
        print(
        ...
        print(
            ...
            f"{np.sqrt(np.mean(lignad_final_force_norms**2)):.6f} A"
        )
...
def main(
    ...
    pocket_cutoffs: list[float] = typer.Option(
        ...
        help=(
            ...
            "Defaults to 2, 5, 10 and 20 A; selection uses strict '< cutoff'."
        ),
    ),
