...
# Submit with:
#
#   sbatch run_3SQQ_multiple_cutoffs_cpu_corrected.sh
#
# Cutoff meanings:
#
...
PYTHON_SCRIPT="${WORK_DIR}/mopac_mlp_test4_corrected.py"
...
PDB_ID="${PDB_ID:-3SQQ}"  # Default to 3SQQ if not set in the environment       
